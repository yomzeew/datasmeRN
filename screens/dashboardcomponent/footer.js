...
const Footer=()=>{
    ...
    return(
        <View className={`w-full ${Platform.OS==='android'?'h-20':'h-24'} bg-slate-100 absolute bottom-0 px-4`}>
            ...
            <Text className="text-xs text-blue-600">Home</Text></TouchableOpacity>
            </View>
            <View className="items-center">
            ...
            <View className="opacity-40 bg-blue-300 rounded-full h-12 w-12" />
            <View className="absolute h-12 w-12 items-center flex justify-center">
                <AntDesign  name="filetext1" size={20} color="#509DFF" /></View>
            </View>
            <Text className="text-xs text-blue-600">Transaction</Text></TouchableOpacity>
            </View>
            <View className="items-center">
            <TouchableOpacity  className="items-center" onPress={handlefund} >
            <View>
            <View className="opacity-40 bg-blue-300 rounded-full h-12 w-12" />
            <View className="absolute h-12 w-12 items-center flex justify-center"><Entypo name="wallet" size={20} color="#509DFF" /></View>
                </View>
                    <Text className="text-xs text-blue-600">Fund Wallet</Text>
            </TouchableOpacity>
            </View>
            <View className="items-center">
            ...
            <View>
            <View className="opacity-40 bg-blue-300 rounded-full h-12 w-12" />
            <View className="absolute h-12 w-12 items-center flex justify-center"><AntDesign name="meho" size={20} color="#509DFF" /></View>
            </View>
            <Text className="text-xs text-blue-600">Me</Text>
            </TouchableOpacity>
            </View>
